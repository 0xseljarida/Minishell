SRC = main_parsing.c parsing/free.c parsing/tokenizer.c parsing/tokenizer_utils.c parsing/ast_parser.c parsing/glblist.c parsing/expanding_utils_extra.c\
