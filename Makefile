SRC = main.c parsing/free.c parsing/tokenizer.c parsing/tokenizer_utils.c  parsing/glblist.c parsing/expanding_utils_extra.c\
	...
	builtins/cd.c builtins/echo.c builtins/env.c exec/global.c exec/signals_handlers.c exec/signals_setup.c exec/exec_builtins.c builtins/exit.c builtins/exit_utils.c builtins/export.c builtins/pwd.c builtins/unset.c \
